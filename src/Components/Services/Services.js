...
<div className='serviceCards'>
    ...
    <div className='skillCard'>
        <img src='/world-wide-web.png' id='cardIcons'/>
...
<div className='serviceCards'>
    ...
    <div className='skillCard'>
        <img src='/mobile-development.png' id='cardIcons'/>
    ...
    <div className='skillCard'>
        <img src='/responsive.png'id='cardIcons'/>
